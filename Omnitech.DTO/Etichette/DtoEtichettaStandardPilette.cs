...
using Omnitech.Enum.Psr;

namespace Omnitech.DTO.Etichette
{
    public class DtoEtichettaStandardPilette
    {
        //NOTA BENE:  Versione ridotta di DtoEtichettaStandard a cui sono state tolte/commentate le proprietà inutili ed aggiunte delle altre....
        ...
        public Omnitech.Enum.Psr.LabelLayout ProductLabelType { get; set; }
        ...
        public Omnitech.Enum.Psr.TipologiaArticolo TipologiaArticoloMaster { get; set; }
        public Omnitech.Enum.Psr.TipologiaImballo TipologiaImballo { get; set; }
        public Omnitech.Enum.Psr.TipologiaRinforzoImballo TipologiaRinforzoImballo { get; set; }

        public Omnitech.Enum.Psr.TipoFaP FaP { get; set; }                   //(da ordine.FaP in PSR)


        public Omnitech.Enum.Psr.TipologiaPiletta TipologiaPiletta { get; set; }
        public Omnitech.Enum.Psr.FormaCover FormaCover { get; set; }
        public Omnitech.Enum.Psr.MaterialeCover MaterialeCover { get; set; }
        ...
        //        {
        //            case Omnitech.Enum.Psr.TipologiaArticolo.TopVascaIntegrata:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.TopVascaIntegrataSemincasso:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Lavanderia:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Monoblocco:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Consolle:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Lavamani:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Mensola:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.LastraPiùVascaSaldata:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Catino:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Laminato:
        //                {
        //                    switch (TipologiaImballo)
        //                    {
        //                        case Omnitech.Enum.Psr.TipologiaImballo.tviTipoA:
        //                        case Omnitech.Enum.Psr.TipologiaImballo.cartone:
        //                            {
        //                                switch (TipologiaRinforzoImballo)
        //                                {
        //                                    case Omnitech.Enum.Psr.TipologiaRinforzoImballo.Gabbia:
        ...
        //                        case Omnitech.Enum.Psr.TipologiaImballo.undefined:
        //                            return (DimensioniL > 1600) ? Path.Combine(BaseLogoPath, $"ico_top_xl.png") : Path.Combine(BaseLogoPath, $"ico_top_n.png");
        ...
        //            case Omnitech.Enum.Psr.TipologiaArticolo.VascaBagno:
        //                return Path.Combine(BaseLogoPath, $"ico_vdb.png");

        //            case Omnitech.Enum.Psr.TipologiaArticolo.PiattoDoccia:
        //                return Path.Combine(BaseLogoPath, $"ico_pdc.png");

        //            case Omnitech.Enum.Psr.TipologiaArticolo.LavaboCostruito:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Cassettiera:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Colonna:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Accessorio:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Alzatina:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Lastra:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Boiserie:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Tavoletta:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Varie:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Campioncini:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Copripiletta:
        //            case Omnitech.Enum.Psr.TipologiaArticolo.Tavolo:
        //            default:
        //                return null;
        //        }
        //    }
        ...
        private string GetCustomLabelReference()
        {
            ...
            switch (Cliente)
            {
                case Omnitech.Enum.Psr.Cliente.Arblu:
                    {
                        switch ($"{a}{d}")
                        {
                            case "00":
                ...
                case Omnitech.Enum.Psr.Cliente.Mobilcrab:
                    {
                        switch ($"{a}{b}{c}")
                        {
                            case "000":
