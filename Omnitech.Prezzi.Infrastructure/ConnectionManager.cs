...
namespace Omnitech.Prezzi.Infrastructure
{
    public static class ConnectionManager
    {
        ...
        private static readonly Dictionary<string, string> _connections = new Dictionary<string, string>
        {
            ...
            { "dual", "Data Source=192.168.1.190;Initial Catalog=AvanzamentoProduzione;Persist Security Info=True;User ID=rickyreds;Password=Omni!2k25@rReds!;Pooling=False;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Application Name=\"SQL Server Management Studio\";Connect Timeout=30" },
        };
